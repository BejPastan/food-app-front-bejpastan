...
export interface UnitTileProps extends GenericTileProp<Unit> {
}

export default function UnitTile({ data, onPress }: UnitTileProps) {
...
//#endregion
    return (
        <TouchableOpacity onPress={() => onPress && onPress(data.id)} activeOpacity={0.7} style = {[style.container]}>
                ...
                />
                <Text 
                    content={`${data.volumeEquivalent} liters`}            
                    type="caption"
                    variant="paper-sec"
                    mode="hand"
                />
